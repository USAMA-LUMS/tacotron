...
from datasets import blizzard, ljspeech, urdu
...
def preprocess_urdu(args):
  in_dir = os.path.join(args.base_dir, 'Urdu')
  out_dir = os.path.join(args.base_dir, args.output)
  os.makedirs(out_dir, exist_ok=True)
...
def main():
  ...
  parser.add_argument('--dataset', required=True, choices=['blizzard', 'ljspeech','urdu'])
